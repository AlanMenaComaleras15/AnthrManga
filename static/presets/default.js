...
"ui-font-family"             : "lato", // CSS font-family value as "'Helvetica', sans-serif" or ""
...
"website-name-in-title"    : "~/manga", // "" or name of your website replaces string "Bibi" in <title>.
"website-name-in-menu"     : "Anthr~/manga", // "" or name of your website appears in setting-menu as a link. (Requires "website-href")
"website-href"             : "manga.anthr.net", // "" or URL of your website to be used for the link in setting-menu. (Requires "website-name-in-menu")
...
// But on the other hand, it may also allow XSS of malicious EPUB in some cases.
  ...
  /* !!!! BE CAREFUL !!!! */ "trustworthy-origins" : ["https://aluyrcjqzpacibftkfwr.supabase.co", "https://localhost:7000"], // origins you trust other than where this Bibi is installed. (blank is recommended).
